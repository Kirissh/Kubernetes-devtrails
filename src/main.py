...
def main():
    ...
    # Use the same feature names logic as in the model class
    feature_names = X_train.columns
    if 'timestamp' in feature_names and len(feature_names) != len(feature_importances):
    ...
    if len(feature_names) == len(feature_importances):
        ...
        print(f"Warning: Could not create feature importance plot due to dimension mismatch: {len(feature_names)} features vs {len(feature_importances)} importances.")
